/*
  ...
  3. Indexes
    - Add index on product_id and branch for faster lookups
...
CREATE TABLE IF NOT EXISTS inventory (
  ...
  CONSTRAINT inventory_branch_check CHECK (branch IN (
    'hcm-district1', 'hcm-district3', 'hcm-district5', 
    'hcm-district7', 'hcm-tanbinh', 'hcm-binhthanh'
  ))
);
...
SELECT 
  ...
  b.branch,
  CASE 
    WHEN b.branch = 'hcm-district1' THEN p.stock_quantity
    WHEN b.branch = 'hcm-district3' THEN GREATEST(0, p.stock_quantity - 20)
    WHEN b.branch = 'hcm-district5' THEN GREATEST(0, p.stock_quantity - 10)
    WHEN b.branch = 'hcm-district7' THEN GREATEST(0, p.stock_quantity - 30)
    WHEN b.branch = 'hcm-tanbinh' THEN GREATEST(0, p.stock_quantity - 15)
    WHEN b.branch = 'hcm-binhthanh' THEN GREATEST(0, p.stock_quantity - 25)
